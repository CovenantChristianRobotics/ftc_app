 ...
 */
public class EncValueTeleOp extends OpMode {
    ...
    public void init() {
        ...
        leftDrive.setMotorChannelMode(1, DcMotorController.RunMode.RESET_ENCODERS);
        leftDrive.setMotorChannelMode(2, DcMotorController.RunMode.RESET_ENCODERS);
        rightDrive.setMotorChannelMode(1, DcMotorController.RunMode.RESET_ENCODERS);
        rightDrive.setMotorChannelMode(2, DcMotorController.RunMode.RESET_ENCODERS);
